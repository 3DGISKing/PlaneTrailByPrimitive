...
//包围球
var boundingSphere = new BoundingSphere(new Cartesian3(0.0, 0.0, 0.0), 2.0);
...
var modelMatrix = Matrix4.multiplyByUniformScale(
    Matrix4.multiplyByTranslation(Transforms.eastNorthUpToFixedFrame(Cartesian3.fromDegrees(116.23, 39.54)), new Cartesian3(0.0, 0.0, 25), new Matrix4()),
    25.0,
    new Matrix4()
);
//四面体的实例
